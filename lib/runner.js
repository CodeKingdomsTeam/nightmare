  ...
  parent.on('javascript', function(src) {
    ...
    var tryRun = function() {
       ...
       if( win.webContents.getURL() && !win.webContents.isLoading() ) {
          ...
          console.log('Deferring executeJavaScript till page loads...');
